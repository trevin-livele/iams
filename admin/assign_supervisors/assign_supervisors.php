...
$regions = array(
	"Greater Accra Region", "Central Region", "Eastern Region", "Western Region",
	"Ashanti Region", "Northern Region", "Upper East Region", "Upper West", "Volta Region", "Brong Ahafo Region"
);

$regions_2 = array(
	"-- Select Resident Region --", "Greater Accra Region", "Central Region", "Eastern Region", "Western Region",
							...
							<form method="post" action="add_lecturer.php">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="col-md-5 col-md-offset-1">
											<input type="text" placeholder="Enter Contact (0200000000)" required name="txt_lecturer_contact" class="form-control" />
										</div>
